...
function my_acf_init() {
	...
	acf_update_setting('google_api_key', 'AIzaSyDxG1D9c85-BELSZNDxlBD2gptKo2YRU34');
}
...
function yourlink_scripts() {
	...
	wp_enqueue_script( 'google-maps-js', 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDxG1D9c85-BELSZNDxlBD2gptKo2YRU34&sensor=false' );
